...
set MAIN_JAR=dcm4che-tool-storescu-3.3.8.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-image-3.3.8.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-imageio-3.3.8.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-imageio-rle-3.3.8.jar
